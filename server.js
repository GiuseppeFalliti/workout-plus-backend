...
const sampleExercises = [
    ...
    { name: 'Negative one leg front lever', type: 'Back' },
    { name: 'Negative front lever', type: 'Back' },
    { name: 'Tuck front lever', type: 'Back' },
    { name: 'Negative straddle front lever', type: 'Back' },
    { name: 'Straddle front lever', type: 'Back' },
    { name: 'Advanced tuck front lever', type: 'Back' },
    { name: 'Handstand', type: 'Shoulders' },
    { name: 'Planche', type: 'Shoulders' },
    { name: 'Planche push-up', type: 'Shoulders' },
    { name: 'Dragon flag', type: 'Core' },
    { name: 'Back lever', type: 'Back' },
    { name: 'Muscle up negatives', type: 'Back, Triceps' },
    { name: 'L-sit', type: 'Core' },
    { name: 'V-sit', type: 'Core' },
    { name: 'Pistol squat', type: 'Legs' },
    { name: 'L-sit to handstand', type: 'Core, Shoulders' },
